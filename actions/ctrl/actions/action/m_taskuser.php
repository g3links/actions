...
$data = [
    ...
    'projectgroupsroute' => \model\route::window('projupdate',['project/groups/index.php?idproject={0}', \model\env::session_idproject()], \model\env::session_idproject(),\model\lexi::get('','prj103')),
