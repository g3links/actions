...
//    'listroute' => \model\route::form('actions/actions/listtasks.php',['idproject'=>\model\env::session_idproject(),'idgate'=>\model\env::session_lastviewgate(),'navpage'=>'[navpage]','sort'=>'[sorttype]','sortdirection'=>'[sortdirection]','idtrack'=>'[idtrack]']),
    'searchtagactionsroute' => \model\route::window('search',['actions/search/index.php?idproject={0}&idgate={1}&type=[type]&search=[searchtext]', 0, \model\env::session_lastviewgate()], \model\env::session_idproject(), \model\lexi::get('', 'prj049'),''),
//    'searchtagactionsroute' => \model\route::window('search',['actions/search/index.php',['idproject'=>0,'idgate'=>\model\env::session_lastviewgate(),'type'=>'[type]','search'=>'[searchtext]']], \model\env::session_idproject(), \model\lexi::get('', 'prj049'),''),
