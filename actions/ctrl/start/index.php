...
$data = [
    ...
    'searchtagsroute' => \model\route::window('search',['actions/search/index.php?type=[type]&search=[searchtext]&idgate=1'] , \model\env::getUserIdProject(), \model\lexi::get('', 'prj049'),''),
];
